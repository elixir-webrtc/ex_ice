defmodule ExICE.Priv.Candidate.Srflx do
  @moduledoc false
  ...
  @impl true
  def new(config) do
    %__MODULE__{base: CandidateBase.new(:srflx, config)}
  end
  ...
  def send_data(cand, dst_ip, dst_port, data) do
    cand.base.transport_module.send(cand.base.socket, {dst_ip, dst_port}, data)
    {:ok, cand}
  end
